...
export async function POST(req) {
  ...
  try {
    ...
    return new Response(
      JSON.stringify({ text: response.choices[0].message.content.trim() }),
      {
        status: 200,
      }
    );
